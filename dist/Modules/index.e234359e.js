...
var stateClone = Object.assign({
}, state);
var stateDeepClone = (0, _cloneDeep["default"])(state); // stateClone: 
// cart: (2) [{…}, {…}]
// user: {loggedIn: true}     //! true
state.user.loggedIn = false; // cart: (2) [{…}, {…}]
...
//TODO 
var Person = /*#__PURE__*/ _createClass(function Person1(name) {
    _classCallCheck(this, Person1);
    _defineProperty(this, "greeting", 'Hey');
    this.name = name;
    console.log("".concat(this.greeting, ", ").concat(this.name));
});
var jonas = new Person('Jonas'); //* Hey, Jonas
console.log((_Jonas = 'Jonas', _Jonas !== void 0) ? _Jonas : null); // console.log(cart.find(el => el.quantity >= 2));
...
},{"./shoppingCart.js":"38VDv","../node_modules/lodash-es/cloneDeep.js":"dd5At","core-js/stable":"7CRIE"}],"38VDv":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.tq = exports.totalPrice = exports.cart = exports.addToCart = void 0;
// Exporting module
// this code will executed FIRST
// 1
console.log('Exporting module'); // Blocking code : only after executing this block, other code will be call to run: see console
...
// Importing module
var shippingCost = 10; // const cart = [];
// 7
var cart = []; // 2
...
var totalQuantity = 23; // export { totalPrice, totalQuantity }
// 5
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7CRIE":[function(require,module,exports) {
...
},{"../internals/export":"dIGt4","../internals/function-call":"d7JlP"}]},["iAea7","9Beov"], "9Beov", "parcelRequire2041")
